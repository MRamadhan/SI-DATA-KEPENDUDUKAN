			...
			if(!isset($_SESSION['sebagai'],$_SESSION['nama'],$_SESSION['pass'])){
				...
				if(!isset($_GET['proses'])){
					...
					<tr style=\"background:#ccc;\">
						<th width=\"17%\" style=\"border:1px solid #000;\">
							<a style=\"float:left;\" href=\"anggota-order-id_anggota-desc\"><img src=\"images/top.png\"/></a>ID KELUARGA
							<a style=\"float:right;\" href=\"anggota-order-id_anggota-asc\"><img src=\"images/down.png\"/></a>
						</th>
						<th width=\"25%\" style=\"border:1px solid #000;\">
							<a style=\"float:left;\" href=\"anggota-order-nama_anggota-desc\"><img src=\"images/top.png\"/></a>NAMA KK
							<a style=\"float:right;\" href=\"anggota-order-nama_anggota-asc\"><img src=\"images/down.png\"/></a>
						</th>
						<th width=\"25%\" style=\"border:1px solid #000;\">
							<a style=\"float:left;\" href=\"anggota-order-alamat-desc\"><img src=\"images/top.png\"/></a>ALAMAT LENGKAP
						...
						<th width=\"18%\" style=\"border:1px solid #000;\">Proses</th>
					</tr>";
						if(!isset($_GET['order'])){
				...
				echo "
					...
					<tr style=\"background:#ccc;\">
						...
						<th width=\"18%\" style=\"border:1px solid #000;\">
							<a style=\"float:left;\" href=\"anggota-order-telepon-desc\"><img src=\"images/top.png\"/></a>TELEPON
							<a style=\"float:right;\" href=\"anggota-order-telepon-asc\"><img src=\"images/down.png\"/></a>
						</th>
					</tr>";
